...
BEGIN_MESSAGE_MAP(CosgFreeApp, CWinAppEx)
...
CosgFreeApp::CosgFreeApp()
{
	...
	SetAppID(_T("osgFree.AppID.NoVersion"));

	// TODO: 在此处添加构造代码，
	// 将所有重要的初始化放置在 InitInstance 中
}

// 唯一的一个 CosgFreeApp 对象
...
// CosgFreeApp 自定义加载/保存方法

void CosgFreeApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CosgFreeApp::LoadCustomState()
{
}

void CosgFreeApp::SaveCustomState()
{
}
